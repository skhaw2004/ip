...
`scripts/generate-split-view-diff.py` is the bundled standard-library-only generator (no packages to install). Keep the page self-contained except for optional syntax-highlighting resources loaded by the page.
